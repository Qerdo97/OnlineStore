...
namespace OnlineStore.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public OrderItemsController(OnlineStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var onlineStoreContext = _context.OrderItems.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OnlineStoreContext.OrderItems'  is null.");
            }
            var orderItem = await _context.OrderItems.FindAsync(id);
            if (orderItem != null)
            {
